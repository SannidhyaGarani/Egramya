            ...
            <section className="relative max-w-6xl mx-auto px-6 pb-32">
                ...
                >
                    <TopicCard 
                        ...
                        description="Selection of suitable cattle/buffalo breeds based on local climate, housing design, hygiene, and animal welfare."
                        items={[
                            "Indigenous, crossbred & exotic breeds",
                            "Breed selection based on climate",
                            "Housing design & animal comfort"
                        ]}
                        outcome="VDC advises farmers on suitable breeds and housing systems."
                    />
                    ...
                    <TopicCard 
                        ...
                        description="Focuses on balanced feeding practices, ration formulation, and feed cost optimization using locally available fodder."
                        items={[
                            "Principles of ruminant digestion",
                            "Ration balancing for different stages",
                            "Cost-effective feed formulation"
                        ]}
                        outcome="Reduced feed cost and improved milk yield per animal."
                    />
                    ...
                    <TopicCard 
                        ...
                        description="Explains heat detection, breeding cycles, artificial insemination basics, and genetic improvement strategies."
                        items={[
                            "Heat detection & breeding cycles",
                            "Artificial insemination concepts",
                            "Calving management protocols"
                        ]}
                        outcome="Reduced calving interval and improved herd productivity."
                    />
                    ...
                    <TopicCard 
                        ...
                        description="Trains VDCs on common dairy diseases, vaccination schedules, biosecurity, and clean milk production practices."
                        items={[
                            "Common diseases & vaccination protocols",
                            "Biosecurity & farm sanitation",
                            "Milk testing & hygienic milking"
                        ]}
                        outcome="First-level animal health & hygiene advisor capability."
                    />
                </motion.div>
