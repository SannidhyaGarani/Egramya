...
const ImpactMetric = ({ label, value }) => (
    <div className="min-w-[260px] bg-white/80 backdrop-blur-md border border-white rounded-[2rem] px-8 py-8 shadow-sm">
        <p className="text-[10px] uppercase tracking-[0.2em] text-[#0ea771] font-bold mb-3">
            {label}
        </p>
    ...
    >
        ...
        <div className="lg:col-span-4">
            <div className="flex items-center gap-4 mb-6">
                <div className="p-3 bg-stone-900 text-white rounded-2xl group-hover:bg-[#0ea771] transition-colors duration-500">
            ...
            {items.map((item, i) => (
                ...
                >
                    ...
                    <div className="flex justify-end">
                        <ArrowUpRight size={16} className="text-[#0ea771] opacity-0 group-hover/card:opacity-100 transition-all transform group-hover/card:translate-x-1" />
                    </div>
                </div>
            ))}
        </div>
            ...
            <header className="relative h-[45vh] min-h-[400px] overflow-hidden mt-25">
                ...
                <div className="relative h-full max-w-6xl mx-auto px-6 flex flex-col justify-end pb-12">
                    ...
                    >
                        ...
                        <ChevronRight size={12} />
                        <span className="text-white border-b border-[#0ea771]">Impact</span>
                    </motion.div>
                    ...
                    >
                        Impact That <span className="italic text-[#0ea771]">Sustains Villages</span>
                    </motion.h1>
            ...
            <section className="max-w-6xl mx-auto px-6 pb-40">
                <div className="bg-stone-900 rounded-[3rem] p-12 lg:p-24 relative overflow-hidden text-center">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        <span className="text-[#0ea771] font-bold tracking-[0.4em] text-[10px] uppercase mb-8 block">Long-Term Vision</span>
                        <h2 className="font-serif text-4xl lg:text-5xl text-white mb-8 leading-tight">
                            ...
                            <span className="italic text-[#0ea771]"> systemic change.</span>
                        </h2>
                        ...
                        <div className="h-px w-24 bg-[#0ea771] mx-auto mb-12" />
