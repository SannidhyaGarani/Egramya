...
const ModuleSummaryCard = ({ weekRange, type, title, description, skills, icon: Icon, color, href }) => (
  <motion.div 
    variants={fadeInUp}
  ...
  >
    ...
    <div className="lg:col-span-3 flex lg:flex-col items-center lg:items-end gap-4 lg:pt-2">
      <div className="flex flex-col items-center lg:items-end">
        <span className="text-[#0ea771] font-bold tracking-[0.2em] text-[10px] uppercase mb-1">Timeline</span>
      ...
      <div className="group bg-white rounded-[2.5rem] p-8 lg:p-12 border border-stone-100 shadow-sm hover:shadow-xl hover:shadow-stone-200/50 transition-all duration-500 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex flex-wrap items-center gap-4 mb-6">
            <div className="p-3 bg-stone-50 rounded-2xl text-[#0ea771] group-hover:bg-[#0ea771] group-hover:text-white transition-colors duration-300">
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-10">
            {skills.map((skill, idx) => (
              <div key={idx} className="flex items-start gap-3">
                <CheckCircle2 size={16} className="text-[#0ea771] mt-1 shrink-0" />
          ...
          <a 
            href={href} 
            className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-stone-900 group/link hover:text-[#0ea771] transition-colors"
          >
            Explore Module Details <ExternalLink size={14} className="group-hover/link:translate-x-1 transition-transform" />
          </a>
        </div>
      </div>
    </div>
      ...
      <header className="relative h-[45vh] min-h-[400px] overflow-hidden mt-25">
        ...
        <div className="relative h-full max-w-6xl mx-auto px-6 flex flex-col justify-end pb-12">
            ...
            >
                ...
                <ChevronRight size={12} />
                <span className="text-white border-b border-[#0ea771]">Program Structure</span>
            </motion.div>
          ...
          >
            The Learning <span className="italic text-[#0ea771]">Architecture</span>
          </motion.h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-2 bg-white rounded-[2rem] border border-stone-100 shadow-xl shadow-stone-200/40">
          {[
            ...
            <div key={i} className="flex flex-col items-center justify-center py-6 px-4 text-center border-r last:border-0 border-stone-50">
              <stat.icon size={20} className="text-[#0ea771] mb-3" strokeWidth={1.5} />
      ...
      <section className="max-w-6xl mx-auto px-6 pb-40 relative">
        ...
        >
          <div className="inline-flex flex-col items-center">
            <div className="w-12 h-12 rounded-full bg-[#0ea771] text-white flex items-center justify-center mb-8 shadow-lg shadow-[#0ea771]/30">
              <ArrowDown size={24} />
            </div>
